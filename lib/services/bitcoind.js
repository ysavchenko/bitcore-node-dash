...
/**
 * This will return a list of GovObjects
 * @param {Function} callback
 */
Bitcoin.prototype.govObjectList = function(options, callback) {
  ...
  this.client.gobject('list', function(err, response) {
    ...
    for (var i = 0; i < gobjects.length; i++) {
      var datahex = response.result[gobjects[i]].DataHex;

      var govObject = bitcore.GovObject;
      govObject.prototype = govObject.Proposal.prototype;

      var proposal = new govObject(datahex);

      // TODO: serialize proposal to ensure it's valid
